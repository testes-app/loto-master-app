        ...
        <View style={styles.container}>
            ...
            <View style={styles.dezenasContainer}>
                {DEZENAS.map(d => (
                    <TouchableOpacity
                        key={d}
                        style={[styles.dezenaBtn, dezenasSelecionadas === d ? styles.dezenaBtnAtivo : null]}
                        onPress={() => setDezenasSelecionadas(d)}
                    >
                        <Text style={[styles.dezenaBtnTexto, dezenasSelecionadas === d ? styles.dezenaBtnTextoAtivo : null]}>
                            {d} dez
                        </Text>
                    </TouchableOpacity>
                ))}
            ...
            <View style={styles.filtroContainer}>
                <TouchableOpacity
                    style={[styles.filtroBtn, urgentes ? styles.filtroBtnAtivo : null]}
                    onPress={() => setUrgentes(!urgentes)}
                >
                    <Ionicons name="flame" size={14} color={urgentes ? '#fff' : '#8B5CF6'} />
                    <Text style={[styles.filtroBtnTexto, urgentes ? styles.filtroBtnTextoAtivo : null]}> Ordenar por Urgentes</Text>
                </TouchableOpacity>
            </View>
            ...
            <ScrollView style={styles.scrollView}>
                <View style={styles.content}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        {dezenasSelecionadas === 17 && (
                            <TouchableOpacity 
                                style={styles.eliteBtn}
                                onPress={() => navigation.navigate('Elite17')}
                            >
                                <Ionicons name="diamond" size={14} color="#fff" />
                                <Text style={styles.eliteBtnTexto}> Ver Elite</Text>
                            </TouchableOpacity>
                        )}
                    ...
                    {dados.map((item, index) => {
                        ...
                        return (
                            <View key={index} style={[styles.rankCard, isPodium ? styles.rankCardPodium : null]}>
                                {/* Header */}
                                <View style={styles.rankHeader}>
                                    <View style={styles.rankLeft}>
                                        ...
                                        />
                                        <Text style={[styles.rankNumber, isPodium ? styles.rankNumberPodium : null]}>
                                            #{rank}
                                        </Text>
                                    </View>
                                    <TouchableOpacity
